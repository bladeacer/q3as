...
- **[Ada-83-TLALOC](https://github.com/ViMoBr/Ada-83-TLALOC)** (`../Ada-83-TLALOC`) - Ada 83 compiler and test suite preserving the legacy of Ada 83 (MIL-STD-1815A-1983). Provides Ada 83-era source code for training data covering legacy Ada 83 patterns. *(GPL-3.0-or-later with GCC runtime exception; test suite CC-BY-SA-4.0)* - [**the author has given explicit permission to use this code for model training.**](https://forum.ada-lang.io/t/fine-tuning-8b-ai-model-on-ada-spark/4746/3 )
